...
df = pd.read_csv(r"C:\Users\jesus\OneDrive\Im%C3%A1genes\Escritorio\DataS2.csv", header=None)
print(df.tail())

#############################################################################
print(50 * '=')
print('Plotting the vino data')
print(50 * '-')

# select setosa and versicolor
y = df.iloc[0:128, 4].values
y = np.where(y == 1,-1,1)

# extract sepal length and petal length
X = df.iloc[0:128, [0, 2]].values

# plot data   --- CLASIFICA POR COLORES
plt.scatter(X[:58, 0], X[:58, 1],
            color='red', marker='o', label='1')
plt.scatter(X[58:128, 0], X[58:128, 1],
            color='blue', marker='x', label='2')
...
def plot_decision_regions(X, y, classifier, resolution=0.02):
    ...
    plt.contourf(xx1, xx2, Z, alpha=0.4, cmap="Reds")
...
plt.xlabel('Intensidad [standardized]')
plt.ylabel('Matriz [standardized]')
plt.legend(loc='upper left')
